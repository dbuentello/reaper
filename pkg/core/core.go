...
// Debug puts reaper into debug mode and displays debug messages
var Debug = false

// Verbose puts reaper into verbose mode and displays verbose messages
var Verbose = false

// CurrentDir is the current directory where reaper was executed from
