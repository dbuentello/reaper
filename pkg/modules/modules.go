...
import (
	...
	"github.com/infosechoudini/reaper/pkg/modules/srdi"
)
...
// GetModuleList generates and returns a list of all modules in reaper's "module" directory folder. Used with tab completion
